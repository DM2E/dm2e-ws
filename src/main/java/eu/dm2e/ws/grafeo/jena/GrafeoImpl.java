...
public class GrafeoImpl extends JenaImpl implements Grafeo {
    ...
    public void addObject(Object object) {
        Map<String,String> ns = getAnnotatedNamespaces(object);
        for (String prefix:ns.keySet()) {
            setNamespace(prefix, ns.get(prefix));
        }
        ...
        for (Field field: object.getClass().getDeclaredFields()) {
              if (field.isAnnotationPresent(RDFProperty.class)) {
                  try {
                      try {
                          String value = PropertyUtils.getProperty(object,field.getName()).toString();
                          addTriple(subject, field.getAnnotation(RDFProperty.class).value(), value);
    ...
    protected Map<String,String> getAnnotatedNamespaces(Object object) {
        String key = null;
