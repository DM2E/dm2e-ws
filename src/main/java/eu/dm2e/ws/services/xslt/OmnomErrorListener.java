...
public class OmnomErrorListener implements ErrorListener {
	...
	public void warning(TransformerException exception) {
		...
		if (null != logger) logger.warning(exception.getMessage() + exception);
	...
	public void error(TransformerException exception)
		...
		if (null != logger ) logger.severe("SEVERE XSLT ERROR, VERY BAD: " + exception);
//		logger.severe("SEVERE XSLT ERROR, VERY BAD: " + exception);
	...
	public void fatalError(TransformerException exception)
		...
		if (null != logger ) logger.severe("FATAL XSLT ERROR, VERY BAD: " + exception);
